...
class Image_Stitching():
    ...
    def registration(self,img1,img2):
        ...
        cv2.imwrite('matching1.jpg', img3)
...
def main(path1,path2,path3,path4):
    img1 = cv2.imread(path1)
    img2 = cv2.imread(path2)
    img3 = cv2.imread(path3)
    img4 = cv2.imread(path4)

    final=Image_Stitching().blending(img3,img4)
    # final=Image_Stitching().blending(final,img3)
    # final=Image_Stitching().blending(final,img4)
...
if __name__ == '__main__':
    try:
        ...
        path1 = '/home/nam/바탕화면/CameraCalibration/results/back_1.jpg'
        path2 = '/home/nam/바탕화면/CameraCalibration/results/left_1.jpg'
        path3 = '/home/nam/바탕화면/CameraCalibration/results/right_1.jpg'
        path4 = '/home/nam/바탕화면/CameraCalibration/results/front_1.jpg'
